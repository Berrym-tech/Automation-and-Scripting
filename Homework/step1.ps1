...
# Directory where the malicious code will be written to.
# $sbDir = 'C:\Users\maxbe\Python Code\Week 13\Homework'
# Location where the malicous code will be saved to
$file = "step2.ps1"
# Write a file
