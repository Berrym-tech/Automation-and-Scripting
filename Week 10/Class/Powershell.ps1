...
# $outputName = "C:\Users\maxbe\Desktop\RunningServices.csv"

# Get a list of running services
Get-Service | Where-Object { $_.Status -eq "Running" }
Get-Service | Select-Object Status, Name, DisplayName, BinaryPathName | Export-Csv -Path C:\Users\maxbe\Desktop\RunningServices.csv
